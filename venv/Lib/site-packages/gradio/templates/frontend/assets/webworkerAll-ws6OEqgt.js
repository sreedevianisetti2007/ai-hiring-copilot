import{E as p,U as ht,T as de,F as ft,x as Re,y as Ue,M as P,l as G,d as Be,K as w,t as R,a9 as re,R as ne,w as q,J as Me,a6 as I,a7 as Ge,c as A,B as C,D as L,ag as he,W as Q,ah as M,m as E,ai as pt,a1 as De,aj as fe,S as V,G as B,H as W,ak as mt,al as ie,O as J,am as k,s as se,a0 as Z,n as Ae,p as ze,ab as ke,ad as Oe,o as gt,q as xt,ac as _t,ae as bt,af as vt,an as yt,ao as Tt,ap as ee,aq as wt,ar as Ct,as as pe,e as y,at as Pt}from"./Index-CBc7NH6C.js";import{c as Y,a as St,b as Ft,B as Ie}from"./colorToUniform-3MxHuUz8.js";import"./i18n-BMFXHBPM.js";import"./index-D-jIsajj.js";import"./misc-naf7orrC.js";import"./utils.svelte-DMDsJ18M.js";import"./clone-jVrdajso.js";import"./ImagePreview-CHAH_3F4.js";import"./ScrollFade.svelte_svelte_type_style_lang-DFeiClpE.js";import"./snippet-C90FetD8.js";import"./BlockLabel-CvP7Nk1n.js";import"./DownloadLink-BOTVMuQa.js";import"./Empty-BMuKXtx4.js";import"./ShareButton-BR-m05Mv.js";import"./Download-BIpiZbvF.js";import"./Image-D_xKf911.js";import"./IconButtonWrapper-D9ZdrvBX.js";import"./FullscreenButton-L2IDdJ29.js";import"./Maximize-B3KWZTIh.js";import"./Image-CGRQ6a70.js";/* empty css                                            *//* empty css                                                   */import"./Block-0JdtjTx1.js";import"./index-ByBfs3xv.js";import"./StreamingBar.svelte_svelte_type_style_lang-IUCEqHHb.js";import"./html-DK9vC7Aj.js";import"./index-B_pwUImq.js";import"./Clear-DWI1RiEH.js";/* empty css                                                    */import"./Upload-BVKHMGDt.js";import"./actions-DlEKMuxW.js";/* empty css                                              */import"./Webcam-Bk1mkEGY.js";import"./DropdownArrow-CnLzL4qs.js";import"./Square-SXPh8_b4.js";import"./Spinner-JaNxr7H6.js";import"./StreamingBar-CVFwzghU.js";import"./window-DqWn-BDf.js";import"./tinycolor-DgfFhr0o.js";import"./Plus-CE1gDdYp.js";import"./input-CEUvpNiF.js";import"./Check-BnA2SVMO.js";import"./event-modifiers-CdEA5IGF.js";import"./ArrowUp-DetNno3m.js";import"./Trash-Db46HNNS.js";import"./Undo-9sBKuuL2.js";class Ee{static init(e){Object.defineProperty(this,"resizeTo",{configurable:!0,set(t){globalThis.removeEventListener("resize",this.queueResize),this._resizeTo=t,t&&(globalThis.addEventListener("resize",this.queueResize),this.resize())},get(){return this._resizeTo}}),this.queueResize=()=>{this._resizeTo&&(this._cancelResize(),this._resizeId=requestAnimationFrame(()=>this.resize()))},this._cancelResize=()=>{this._resizeId&&(cancelAnimationFrame(this._resizeId),this._resizeId=null)},this.resize=()=>{if(!this._resizeTo)return;this._cancelResize();let t,r;if(this._resizeTo===globalThis.window)t=globalThis.innerWidth,r=globalThis.innerHeight;else{const{clientWidth:n,clientHeight:i}=this._resizeTo;t=n,r=i}this.renderer.resize(t,r),this.render()},this._resizeId=null,this._resizeTo=null,this.resizeTo=e.resizeTo||null}static destroy(){globalThis.removeEventListener("resize",this.queueResize),this._cancelResize(),this._cancelResize=null,this.queueResize=null,this.resizeTo=null,this.resize=null}}Ee.extension=p.Application;class Ve{static init(e){e=Object.assign({autoStart:!0,sharedTicker:!1},e),Object.defineProperty(this,"ticker",{configurable:!0,set(t){this._ticker&&this._ticker.remove(this.render,this),this._ticker=t,t&&t.add(this.render,this,ht.LOW)},get(){return this._ticker}}),this.stop=()=>{this._ticker.stop()},this.start=()=>{this._ticker.start()},this._ticker=null,this.ticker=e.sharedTicker?de.shared:new de,e.autoStart&&this.start()}static destroy(){if(this._ticker){const e=this._ticker;this.ticker=null,e.destroy()}}}Ve.extension=p.Application;var Rt=`in vec2 aPosition;
